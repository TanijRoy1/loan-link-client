  ...
  return (
    <div className="p-4 py-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="btn px-4 py-2 bg-neutral border rounded-2xl shadow"
          >
            Refresh
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        <div className="p-4 bg-neutral rounded-2xl shadow">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="col-span-2 bg-neutral p-4 rounded-2xl shadow">
        ...
        <div className="bg-neutral p-4 rounded-2xl shadow">
          <div className="flex items-center justify-between mb-3">
          ...
          <div className="space-y-3">
            {usersByRole.map((r) => (
              <div key={r._id} className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-base-200 flex items-center justify-center text-sm font-medium">
                    {r._id[0].toUpperCase()}
                  </div>
                  <div>
